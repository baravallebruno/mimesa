...
<!--[if gt IE 8]><!--> <html class="no-js" lang="es"> <!--<![endif]-->
    ...
    <body id="back-full">
      ...
      <div class="container">
       <div id="loginbox" class="col-md-4 col-xs-12 text-center">
           ...
           <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="login">
                ...
                <button class="btn bt-rojo pull-right" type="submit">Ingresar</button>
           ...
           <a href="<?php echo RUTA; ?>registro.php">No tenes cuenta? Registrate ></a>
       </div> 
      </div>    
